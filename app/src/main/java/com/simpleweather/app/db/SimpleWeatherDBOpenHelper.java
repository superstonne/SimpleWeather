...
public class SimpleWeatherDBOpenHelper extends SQLiteOpenHelper {
    ...
    public SimpleWeatherDBOpenHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
